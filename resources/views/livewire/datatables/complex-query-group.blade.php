                ...
                <div x-data="{
                    ...
                    <span class="flex justify-center space-x-4">
                        <button wire:click="addRule('{{ collect(explode('.', $key))->join('.content.') . '.content' }}')"
                            class="flex items-center space-x-2 px-3 py-2 border border-blue-400 rounded-md bg-white text-blue-500 text-xs leading-4 font-medium uppercase tracking-wider hover:bg-blue-200 focus:outline-none">ADD
                            RULE</button>
                        <button
                    ...
                    <div class="block sm:flex items-center">
                        <div class="flex justify-center sm:block">
                            @if (count($rule['content']) > 1)
                                <div class="mr-8">
                                    <label
                                        class="block uppercase tracking-wide text-xs font-bold py-1 rounded flex justify-between">Logic</label>
                                    <select
                    ...
                    <div class="flex justify-end">
                        @unless ($key === 0)
                            <button
                                ...
                                class="px-3 py-2 rounded bg-red-600 text-white"><x-icons.trash /></button>
                        @endunless
                    </div>
